                        ...
                        <p style="font-size: 11px;font-weight: normal;font-style: italic;color: #333;text-align: center;">
                            <fmt:message key="newsletter.intro.1">
                                ...
                                <c:if test="${not isStudio}">
                                    <fmt:param
                                            value="<a style='color: #0066ff;text-decoration: none;' href='/' name='top'>${renderContext.site.title}</a>"/>
                                </c:if>
                            </fmt:message>
                            <br/>
                            <fmt:message key="newsletter.intro.2"/>
                            <a href="<c:url value="${renderContext.mainResource.node.url}" context="/"/>"
                               target="_blank"
